...
create table teachers (
    ...
    on delete cascade --data form parrent table is deleted data from child table related with FK also deleted
    on update cascade --data form parrent table is updated data from child table related with FK also updated
);
