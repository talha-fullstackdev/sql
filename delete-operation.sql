...
delete from student where marks <= 70; -- deleted the student from table whos marks less then 70
delete from student where grade = "c"; -- delete record base on grade
